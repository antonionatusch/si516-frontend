    ...
    return (
        <CCard>
            ...
            <CCardBody>
                ...
                <p><strong>Paciente:</strong> {history.patientId}</p>
                <p><strong>Médico:</strong> {history.doctorId}</p>
                <p><strong>Motivo:</strong> {history.visitReason}</p>
                <p><strong>Fecha:</strong> {new Date(history.createdAt).toLocaleString()}</p>
            </CCardBody>
        </CCard>
    )
}
