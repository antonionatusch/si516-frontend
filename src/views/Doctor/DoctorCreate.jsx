...
const DoctorCreate = () => {
    ...
    return (
        <CForm onSubmit={handleSubmit}>
            ...
            <CFormInput type="text" name="fullName" value={doctor.fullName} onChange={handleChange} required />

            <CFormLabel>Nombre de usuario</CFormLabel>
            <CFormInput type="text" name="username" value={doctor.username} onChange={handleChange} required />

            <CFormLabel>ID de la oficina</CFormLabel>
            <CFormInput type="text" name="officeId" value={doctor.office} onChange={handleChange} />

            <CButton type="submit" color="primary" className="mt-3">Guardar</CButton>
        </CForm>
    )
}
